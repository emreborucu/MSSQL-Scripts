...
compressedBackupSize  VARCHAR(50),
...
LEFT JOIN sys.databases AS db ON db.name=bs.database_name
...
--Databases with data backup over 48 hours old   
							--SELECT Database_Name, last_db_backup_date AS Last_Backup_Date, B.backupSize, B.compressedBackupSize 
							--FROM (  
							--		SELECT CONVERT(CHAR(100), SERVERPROPERTY('Servername')) AS Server,   
							--		  msdb.dbo.backupset.database_name,   
							--		  MAX(msdb.dbo.backupset.backup_finish_date) AS last_db_backup_date,   
							--		  DATEDIFF(hh, MAX(msdb.dbo.backupset.backup_finish_date), GETDATE()) AS [Backup Age (Hours)],
							--		  SUM(msdb.dbo.backupset.backup_size)/1024 AS backupSize ,
							--		  SUM(compressed_backup_size)/1024 AS compressedBackupSize
							--		FROM msdb.dbo.backupset  
							--		LEFT JOIN msdb.dbo.backupmediafamily  ON msdb.dbo.backupmediafamily.media_set_id = msdb.dbo.backupset.media_set_id 
							...
							--		  bs.backup_size/1024 AS backupSize ,
							--		  compressed_backup_size/1024 AS compressedBackupSize  
							--		FROM master.dbo.sysdatabases sd   
							--		LEFT JOIN msdb.dbo.backupset bs ON sd.name  = bs.database_name 
							--		LEFT JOIN msdb.dbo.backupmediafamily  ON msdb.dbo.backupmediafamily.media_set_id = bs.media_set_id   
...
SELECT 
		...
		CONVERT(VARCHAR(100),backup_start_date,120) AS [Last Full DB Backup Date],
        CAST(LastBackUp.compressed_backup_size / 1048576 AS DECIMAL(10, 2) ) AS [compressedBackupSize],
        physical_device_name AS [Backup File Location]
FROM LastBackUp
WHERE Position = 1
ORDER BY [compressedBackupSize] DESC, [Database];  
...
insert into #JobInfo_
	...
	AND CONVERT(DATE, msdb.dbo.agent_datetime(run_date, run_time), 101)>= CONVERT(DATE,DATEADD(DAY, -1,GETDATE()), 101)
...
<font face="Verdana" color="#ffffff" size="1">SingleUser</font></b></td>                                
 ...
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Instance last Recycled</bold></H3></font>                                  
...
BEGIN
		 ...
		 '</table>                                  
		<p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
		<font face="Verdana" size="4" color="#4d4d4f"><H3><bold>AlwaysOn Status</bold></H3></font>                                  
		<table style="BORDER-COLLAPSE: collapse" borderColor="#111111" cellPadding="0" width="67%" bgColor="#ffffff" borderColorLight="#000000" border="2">                                      
		<tr>                                      
...
BEGIN
		 ...
		 '</table>                                  
		<p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
		<font face="Verdana" size="4" color="#4d4d4f"><H3><bold>LogShipping Status</bold></H3></font>                                  
		<table style="BORDER-COLLAPSE: collapse" borderColor="#111111" cellPadding="0" width="67%" bgColor="#ffffff" borderColorLight="#000000" border="2">                                      
		<tr>                                      
		<th align="LEFT" width="100" bgcolor="#dca300">                                      
...
SELECT                                   
 ...
 '</table>                                  
 <p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Disk Space Report</bold></H3></font>                                  
...
SELECT                                   
 ...
 '</table>                                  
 <p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Tempdb File Usage</bold></H3></font>                                  
 <table id="AutoNumber1" style="BORDER-COLLAPSE: collapse" borderColor="#111111" height="40" cellSpacing="0" cellPadding="0" width="933" border="2">                                  
   <tr>                
...
SELECT                                   
 ...
 '</table>                                  
 <p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Memory Usage</bold></H3></font>                                  
 <table id="AutoNumber1" style="BORDER-COLLAPSE: collapse" borderColor="#111111" height="40" cellSpacing="0" cellPadding="0" width="47%" border="2">                                  
   <tr>                
...
SELECT                                   
	...
	'</table>                                  
	<p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
	<font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Performance Counter Data</bold></H3></font>                                  
	<table id="AutoNumber1" style="BORDER-COLLAPSE: collapse" borderColor="#111111" height="40" cellSpacing="0" cellPadding="0" width="47%" border="2">                                  
	<tr>                
	<th align="left" width="136" bgcolor="#dca300">                                    
...
SELECT                                   
 ...
 '</table>                                  
 <p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Backup Report</bold></H3></font>                                  
 ...
 <th align="left" width="200" bgcolor="#dca300">               
 <font face="Verdana" size="1" color="#FFFFFF">Backup_Size_MB</font></th>
  <th align="left" width="600" bgcolor="#dca300">               
 <font face="Verdana" size="1" color="#FFFFFF">File_Path</font></th>               
   </tr>'                                  
SELECT      
 @TableHTML =  @TableHTML +                                 
  '<tr>'+
 ...
 CASE 
  WHEN DATEDIFF(DAY, CAST(Last_Backup_Date AS DATE), CAST(GETDATE() AS DATE))>1 THEN  '<td><font face="Verdana" size="1" color="#FF0000"><b>' + ISNULL(CONVERT(VARCHAR(100),  Last_Backup_Date,120), '')  +'</b></font></td>'                                       
 ELSE '<td><font face="Verdana" size="1">' + ISNULL(CONVERT(VARCHAR(100),  Last_Backup_Date,120), '')  +'</font></td>' 
 END +
 '<td><font face="Verdana" size="1">' + ISNULL(CONVERT(VARCHAR(100),  compressedBackupSize), '')  +'</font></td>' + 
 '<td><font face="Verdana" size="1">' + ISNULL(CONVERT(VARCHAR(100),  fileLocation), '')  +'</font></td>' +                                            
 '</tr>'                                  
FROM             
 #Backup_Report  
 ...
 '</table>                                  
 <p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Total Number of Database Connections</bold></H3></font>                                  
...
SELECT                                   
 ...
 '</table>                                  
 <p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Database Log Space Usage</bold></H3></font>                                  
 <table id="AutoNumber1" style="BORDER-COLLAPSE: collapse" borderColor="#111111" height="40" cellSpacing="0" cellPadding="0" width="47%" border="2">                                  
   <tr>                
 <th align="left" width="136" bgcolor="#dca300">                                    
 <font face="Verdana" size="1" color="#FFFFFF">Database_Name</font></th>                              
...
SELECT                                   
			...
			'</table>                                  
			<p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
			<font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Job Schedules List (Index Optimize and Check Integrity)</bold></H3></font>                                  
			<table id="AutoNumber1" style="BORDER-COLLAPSE: collapse" borderColor="#111111" height="40" cellSpacing="0" cellPadding="0" width="933" border="2">                                  
			<tr>                
			<th align="Center" width="400" bgcolor="#dca300">                                    
...
SELECT                                   
 ...
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>SQL Agent Job Status (Failure)</bold></H3></font>' +                                      
...
FROM                                   
 ...
 '</table>                                  
 <p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Blocking Process Information</bold></H3></font>                            
...
SELECT                                   
 ...
 '</table>                                  
 <p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Long Running Transactions</bold></H3></font>                                  
 <table id="AutoNumber1" style="BORDER-COLLAPSE: collapse" borderColor="#111111" height="40" cellSpacing="0" cellPadding="0" width="933" border="2">                                  
   <tr>                
 <th align="Center" width="300" bgcolor="#dca300">                                    
 <font face="Verdana" size="1" color="#FFFFFF">SPID</font></th>               
...
from                                   
 #OpenTran_Detail       
								...
								--'</table>                                  
								--<p style="margin-top: 1; margin-bottom: 0">&nbsp;</p>                                  
								--<font face="Verdana" size="4" color="#4d4d4f"><H3><bold>Top 20 Huge Tables</bold></H3></font>                                  
								--<table id="AutoNumber1" style="BORDER-COLLAPSE: collapse" borderColor="#111111" height="40" cellSpacing="0" cellPadding="0" width="933" border="2">                                  
								--<tr>                
								--<th align="Center" width="300" bgcolor="#dca300">                                    
...
SELECT                                   
 ...
 '</table>                   
 <p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>                                
 <font face="Verdana" size="4" color="#4d4d4f"><H3><bold>SQL ErrorLog</bold></H3></font>' +                                    
 '                               
 <table style="BORDER-COLLAPSE: collapse" borderColor="#111111" cellPadding="0" width="47%" bgColor="#ffffff" borderColorLight="#000000" border="2">                                  
 <tr>                                
